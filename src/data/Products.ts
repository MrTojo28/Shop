...
export const Products: TProduct[] = [{id:1,category: ECategories.EXTRACTS,name:'Какой то текст с описанием продукта, 470г',description:['Натуральный флюидный экстракт представлен в удобной стеклянной бутылочке объемом 3 мл с пипеткой-дозатором, которая позволяет точно отмерить необходимое количество продукта. Бутылочка упакована в защитную картонную коробку, обеспечивающую сохранность продукта при транспортировке и хранении.',
        ...
        ],images:[Images.img7,Images.img12], price:100},
    {id:2,category: ECategories.EXTRACTS,name:'Какой то текст с описанием какого то другого продукта, 270г',description:['tese2'],images:[Images.img111,Images.img22], price:200},
    {id:3,category: ECategories.EXTRACTS,name:'Какой то текст с описанием какого то другого продукта, 170г',description:['tese3'],images:[Images.img9,Images.img12], price:250},
    {id:4,category: ECategories.EXTRACTS,name:'Какой то текст с описанием какого то другого продукта, 570г',description:['tese4'],images:[Images.img10,Images.img22], price:50},
